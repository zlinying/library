...
<div class="loginform">
    <div class="col-md-4 column">
        <span id="labellogin">读者登录</span><br>
        <div class="form-group">
            <input type="text" class="form-control" id="usernameinput" name="username" value="${username }" placeholder="用户名"/>
        </div>
        <div class="form-group">
            <input type="password" class="form-control" id="passwordinput" name="password" placeholder="密码"/>
        </div>
        <button id="loginbutton" class="btn btn-primary" onclick="readerLogincheck()">登录</button><br/>
        <button id="loginbutton" class="btn btn-warning" onclick="goToRegist()" style="margin-top:5px;">注册</button>
